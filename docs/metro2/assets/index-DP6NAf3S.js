...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function oc(e,t,n){let r=new Float32Array(Ks),i=new q(0,1,0);return new wo({name:`SphericalGaussianBlur`,defines:{n:Ks,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:lc(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function sc(){return new wo({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:lc(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function cc(){return new wo({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:lc(),fragmentShader:`
	...
	`}var uc=class extends Xt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new zi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};kd.BlurDirectionX=new K(1,0),kd.BlurDirectionY=new K(0,1);var Ad={name:`OutputShader`,uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
		...
		}`},jd=class extends yd{constructor(){super(),this.isOutputPass=!0,this.uniforms=xo.clone(Ad.uniforms),this.material=new To({name:Ad.name,uniforms:this.uniforms,vertexShader:Ad.vertexShader,fragmentShader:Ad.fragmentShader}),this._fsQuad=new Sd(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},Y.getTransfer(this._outputColorSpace)===`srgb`&&(this.material.defines.SRGB_TRANSFER=``),this._toneMapping===1?this.material.defines.LINEAR_TONE_MAPPING=``:this._toneMapping===2?this.material.defines.REINHARD_TONE_MAPPING=``:this._toneMapping===3?this.material.defines.CINEON_TONE_MAPPING=``:this._toneMapping===4?this.material.defines.ACES_FILMIC_TONE_MAPPING=``:this._toneMapping===6?this.material.defines.AGX_TONE_MAPPING=``:this._toneMapping===7?this.material.defines.NEUTRAL_TONE_MAPPING=``:this._toneMapping===5&&(this.material.defines.CUSTOM_TONE_MAPPING=``),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},Md=new q;function Nd(e,t,n,r,i,a){let o=2*Math.PI*i/4,s=Math.max(a-2*i,0),c=Math.PI/4;Md.copy(t),Md[r]=0,Md.normalize();let l=.5*o/(o+s),u=1-Md.angleTo(e)/c;return Math.sign(Md[n])===1?u*l:s/(o+s)+l+l*(1-u)}var Pd=class e extends Wi{constructor(e=1,t=1,n=1,r=2,i=.1){let a=r*2+1;if(i=Math.min(e/2,t/2,n/2,i),super(1,1,1,a,a,a),this.type=`RoundedBoxGeometry`,this.parameters={width:e,height:t,depth:n,segments:r,radius:i},a===1)return;let o=this.toNonIndexed();this.index=null,this.attributes.position=o.attributes.position,this.attributes.normal=o.attributes.normal,this.attributes.uv=o.attributes.uv;let s=new q,c=new q,l=new q(e,t,n).divideScalar(2).subScalar(i),u=this.attributes.position.array,d=this.attributes.normal.array,f=this.attributes.uv.array,p=u.length/6,m=new q,h=.5/a;for(let r=0,a=0;r<u.length;r+=3,a+=2)switch(s.fromArray(u,r),c.copy(s),c.x-=Math.sign(c.x)*h,c.y-=Math.sign(c.y)*h,c.z-=Math.sign(c.z)*h,c.normalize(),u[r+0]=l.x*Math.sign(s.x)+c.x*i,u[r+1]=l.y*Math.sign(s.y)+c.y*i,u[r+2]=l.z*Math.sign(s.z)+c.z*i,d[r+0]=c.x,d[r+1]=c.y,d[r+2]=c.z,Math.floor(r/p)){case 0:m.set(1,0,0),f[a+0]=Nd(m,c,`z`,`y`,i,n),f[a+1]=1-Nd(m,c,`y`,`z`,i,t);break;case 1:m.set(-1,0,0),f[a+0]=1-Nd(m,c,`z`,`y`,i,n),f[a+1]=1-Nd(m,c,`y`,`z`,i,t);break;case 2:m.set(0,1,0),f[a+0]=1-Nd(m,c,`x`,`z`,i,e),f[a+1]=Nd(m,c,`z`,`x`,i,n);break;case 3:m.set(0,-1,0),f[a+0]=1-Nd(m,c,`x`,`z`,i,e),f[a+1]=1-Nd(m,c,`z`,`x`,i,n);break;case 4:m.set(0,0,1),f[a+0]=1-Nd(m,c,`x`,`y`,i,e),f[a+1]=1-Nd(m,c,`y`,`x`,i,t);break;case 5:m.set(0,0,-1),f[a+0]=Nd(m,c,`x`,`y`,i,e),f[a+1]=1-Nd(m,c,`y`,`x`,i,t)}}static fromJSON(t){return new e(t.width,t.height,t.depth,t.segments,t.radius)}};function Fd(e,t=!1){let n=e[0].index!==null,r=new Set(Object.keys(e[0].attributes)),i=new Set(Object.keys(e[0].morphAttributes)),a={},o={},s=e[0].morphTargetsRelative,c=new jr,l=0;for(let u=0;u<e.length;++u){let d=e[u],f=0;if(n!==(d.index!==null))return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. All geometries must have compatible attributes; make sure index attribute exists among all geometries, or in none of them.`),null;for(let e in d.attributes){if(!r.has(e))return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. All geometries must have compatible attributes; make sure "`+e+`" attribute exists among all geometries, or in none of them.`),null;a[e]===void 0&&(a[e]=[]),a[e].push(d.attributes[e]),f++}if(f!==r.size)return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. Make sure all geometries have the same number of attributes.`),null;if(s!==d.morphTargetsRelative)return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. .morphTargetsRelative must be consistent throughout all geometries.`),null;for(let e in d.morphAttributes){if(!i.has(e))return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`.  .morphAttributes must be consistent throughout all geometries.`),null;o[e]===void 0&&(o[e]=[]),o[e].push(d.morphAttributes[e])}if(t){let e;if(n)e=d.index.count;else if(d.attributes.position!==void 0)e=d.attributes.position.count;else return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. The geometry must have either an index or a position attribute`),null;c.addGroup(l,e,u),l+=e}}if(n){let t=0,n=[];for(let r=0;r<e.length;++r){let i=e[r].index;for(let e=0;e<i.count;++e)n.push(i.getX(e)+t);t+=e[r].attributes.position.count}c.setIndex(n)}for(let e in a){let t=Id(a[e]);if(!t)return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed while trying to merge the `+e+` attribute.`),null;c.setAttribute(e,t)}for(let e in o){let t=o[e][0].length;if(t!==0){c.morphAttributes=c.morphAttributes||{},c.morphAttributes[e]=[];for(let n=0;n<t;++n){let t=[];for(let r=0;r<o[e].length;++r)t.push(o[e][r][n]);let r=Id(t);if(!r)return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed while trying to merge the `+e+` morphAttribute.`),null;c.morphAttributes[e].push(r)}}}return c}function Id(e){let t,n,r,i=-1,a=0;for(let o=0;o<e.length;++o){let s=e[o];if(t===void 0&&(t=s.array.constructor),t!==s.array.constructor)return console.error(`THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.array must be of consistent array types across matching attributes.`),null;if(n===void 0&&(n=s.itemSize),n!==s.itemSize)return console.error(`THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.itemSize must be consistent across matching attributes.`),null;if(r===void 0&&(r=s.normalized),r!==s.normalized)return console.error(`THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.normalized must be consistent across matching attributes.`),null;if(i===-1&&(i=s.gpuType),i!==s.gpuType)return console.error(`THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.gpuType must be consistent across matching attributes.`),null;a+=s.count*n}let o=new t(a),s=new gr(o,n,r),c=0;for(let t=0;t<e.length;++t){let r=e[t];if(r.isInterleavedBufferAttribute){let e=c/n;for(let t=0,i=r.count;t<i;t++)for(let i=0;i<n;i++){let n=r.getComponent(t,i);s.setComponent(t+e,i,n)}}else o.set(r.array,c);c+=r.count*n}return i!==void 0&&(s.gpuType=i),s}var Ld=1.6,Rd=2.1,zd=1.9;function Bd(e){let t=e>>>0;return()=>{t=t+1831565813>>>0;let e=t;return e=Math.imul(e^e>>>15,e|1),e^=e+Math.imul(e^e>>>7,e|61),((e^e>>>14)>>>0)/4294967296}}function Vd(e,t){let n=document.createElement(`canvas`);n.width=n.height=64;let r=n.getContext(`2d`),i=r.createRadialGradient(32,32,2,32,32,32);return i.addColorStop(0,e),i.addColorStop(1,t),r.fillStyle=i,r.fillRect(0,0,64,64),new Bi(n)}function Hd(){let e=document.createElement(`canvas`);e.width=32,e.height=64;let t=e.getContext(`2d`);t.fillStyle=`#000`,t.fillRect(0,0,32,64);let n=Bd(7);for(let e=4;e<60;e+=7)for(let r=3;r<29;r+=6)n()<.34&&(t.fillStyle=n()<.8?`#ffd98a`:`#cfe6ff`,t.fillRect(r,e,3,4));let r=new Bi(e);return r.wrapS=r.wrapT=c,r}function Ud(e){let t=new Map,n=(e,t)=>e<t?`${e}|${t}`:`${t}|${e}`;for(let r of e.lines)for(let e=0;e<r.stationIds.length-1;e++){let i=n(r.stationIds[e],r.stationIds[e+1]);t.has(i)||t.set(i,[]),t.get(i).push(r.id)}return{laneOf(r,i){let a=e.lines.find(e=>e.id===r),o=n(a.stationIds[i],a.stationIds[i+1]),s=t.get(o);return(s.indexOf(r)-(s.length-1)/2)*zd}}}var Wd=class{game;renderer;scene=new Ln;camera;controls;composer=null;bloom=null;sun;hemi;nightAmbient;water;landMat;buildingMat;trackMats=[];lampMat;trainGroups=[];trainMats=[];beamMats=[];lanes;fog;constructor(e,t,r){this.game=t;let i=t.city,a=new q(i.size/2,0,i.size/2);this.lanes=Ud(i),this.renderer=new Ju({canvas:e,antialias:!0}),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.renderer.shadowMap.enabled=!0,this.renderer.shadowMap.type=2,this.renderer.toneMapping=4,this.renderer.toneMappingExposure=.92,this.camera=new ns(38,1,1,4e3),this.camera.position.set(a.x+210,240,a.z+330),this.controls=new ad(this.camera,e),this.controls.target.copy(a),this.controls.enableDamping=!0,this.controls.autoRotate=!0,this.controls.autoRotateSpeed=.35,this.controls.maxPolarAngle=1.32,this.controls.minDistance=60,this.controls.maxDistance=700,this.fog=new In(13624051,700,1900),this.scene.fog=this.fog,this.sun=new as(16777215,1.55),this.sun.castShadow=!0,this.sun.shadow.mapSize.set(2048,2048);let o=this.sun.shadow.camera;o.left=-320,o.right=320,o.top=320,o.bottom=-320,o.far=1500,this.sun.target.position.copy(a),this.scene.add(this.sun,this.sun.target),this.hemi=new Wo(14674677,10130828,.55),this.scene.add(this.hemi),this.nightAmbient=new os(4608110,0),this.scene.add(this.nightAmbient),this.water=new Eo({color:12440552,roughness:.35,metalness:.1});let s=new Z(new po(4e3,4e3),this.water);s.rotation.x=-Math.PI/2,s.position.set(a.x,0,a.z),s.receiveShadow=!0,this.scene.add(s),this.landMat=new Eo({color:15724006,roughness:.95});for(let e of i.lands){let t=new wa;e.forEach(([e,n],r)=>{r===0?t.moveTo(e,-n):t.lineTo(e,-n)});let n=new co(t,{depth:Ld,bevelEnabled:!0,bevelThickness:.6,bevelSize:1.2,bevelSegments:2});n.rotateX(-Math.PI/2);let r=new Z(n,this.landMat);r.receiveShadow=!0,r.castShadow=!0,this.scene.add(r)}let c=new Eo({color:8369530,roughness:1});for(let e of i.parks){let t=new Z(new Wi(e.w,.5,e.h),c);t.position.set(e.cx,1.85,e.cy),t.rotation.y=-e.rot*Math.PI/180,t.receiveShadow=!0,this.scene.add(t)}let l=[],u=[];for(let e of i.lines){let n=t.paths.get(e.id),r=[];for(let t=0;t<n.points.length-1;t++){let i=n.points[t],a=n.points[t+1],o=a.x-i.x,s=a.y-i.y,c=Math.hypot(o,s);if(c<.001)continue;l.push({ax:i.x,ay:i.y,bx:a.x,by:a.y});let d=this.lanes.laneOf(e.id,t),f=-s/c*d,p=o/c*d,m=new Wi(c,.4,1.7);m.rotateY(-Math.atan2(s,o)),m.translate((i.x+a.x)/2+f,Rd,(i.y+a.y)/2+p),r.push(m);let h=new Wi(c+.8,.3,2.6);h.rotateY(-Math.atan2(s,o)),h.translate((i.x+a.x)/2+f,1.86,(i.y+a.y)/2+p),u.push(h)}let i=Fd(r),a=new Eo({color:new X(e.color),emissive:new X(e.color),emissiveIntensity:0,roughness:.6,transparent:!0});this.trackMats.push(a);let o=new Z(i,a);o.castShadow=!0,this.scene.add(o)}let d=new Z(Fd(u),new Eo({color:4605514,roughness:1}));d.castShadow=!0,d.receiveShadow=!0,this.scene.add(d);let f=new Map;for(let e of i.lines)for(let t of e.stationIds)f.set(t,(f.get(t)??0)+1);let p=new Eo({color:16777215,roughness:.4});this.lampMat=new Lr({map:Vd(`rgba(255,217,138,0.95)`,`rgba(255,217,138,0)`),blending:2,depthWrite:!1,transparent:!0,opacity:0});let m=[];for(let e of i.stations){let t=(f.get(e.id)??1)>1?2.3:1.55,n=new Ki(t,t,.5,20);n.translate(e.x,2.25,e.y),m.push(n);let r=new Zr(this.lampMat);r.position.set(e.x,4.5,e.y),r.scale.setScalar(4.5+(f.get(e.id)??1)*1.2),this.scene.add(r)}let h=new Z(Fd(m),p);h.castShadow=!0,this.scene.add(h);let g=(e,t,n)=>{let r=n.bx-n.ax,i=n.by-n.ay,a=e-n.ax,o=t-n.ay,s=r*a+i*o,c=r*r+i*i,l=c>0?Math.min(Math.max(s/c,0),1):0;return Math.hypot(e-(n.ax+r*l),t-(n.ay+i*l))},_={x:44,z:336},v={x:484,z:450},y=(e,t)=>Math.hypot(e-_.x,t-_.z)<18.5||Math.abs(e-v.x)<15&&t>414&&t<486,b=[],x=[],S=[];i.stations.forEach((e,t)=>{let r=Bd(t*2654435761),a=Math.round(12+e.demand*18);for(let t=0;t<a;t++){let t=r()*Math.PI*2,a=4.2+r()*15,o=e.x+Math.cos(t)*a,s=e.y+Math.sin(t)*a;if(!n(i,o,s)||y(o,s)||i.stations.some(e=>Math.hypot(e.x-o,e.y-s)<3.2)||l.some(e=>g(o,s,e)<2.6))continue;let c=Math.hypot(o-220,s-280),u=1+.6*Math.exp(-(c*c)/24200),d=r(),f,p,m;d<.66?(r()<.35?(f=3.4+r()*3,p=1.9+r()*1.1):(f=1.8+r()*1.5,p=1.8+r()*1.5),m=1.8+r()*3):d<.9?(f=2.6+r()*2,p=2.6+r()*2,m=(4.5+r()*5)*(.75+e.demand*.5)):(f=2.3+r()*1.6,p=2.3+r()*1.6,m=(8+r()*9)*(.55+e.demand)*u);let h=(r()-.5)*.14;S.push({x:o,z:s,r:Math.max(f,p)*.75});let _=r();if(_<.5||m<9)b.push({x:o,z:s,y:Ld,w:f,h:m,d:p,rot:h});else if(_<.82){let e=m*.58;b.push({x:o,z:s,y:Ld,w:f,h:e,d:p,rot:h}),b.push({x:o,z:s,y:Ld+e,w:f*.68,h:m-e,d:p*.68,rot:h})}else b.push({x:o,z:s,y:Ld,w:f*1.3,h:2.2,d:p*1.3,rot:h}),b.push({x:o,z:s,y:3.8000000000000003,w:f*.66,h:m-2.2,d:p*.66,rot:h});m>6.5&&r()<.6&&b.push({x:o,z:s,y:Ld+m,w:f*.32,h:.6,d:p*.32,rot:h}),m>14&&r()<.45&&x.push({x:o,z:s,y:Ld+m+.6,h:1.6+r()*2.2})}if(e.demand>=.7&&(f.get(e.id)??1)>1&&t%3==0){let t=r()*Math.PI*2,a=e.x+Math.cos(t)*6.5,o=e.y+Math.sin(t)*6.5;if(n(i,a,o)&&!y(a,o)&&!l.some(e=>g(a,o,e)<2.6)&&!i.stations.some(e=>Math.hypot(e.x-a,e.y-o)<3.2)){let e=24+r()*9,t=(r()-.5)*.14;S.push({x:a,z:o,r:3.2}),b.push({x:a,z:o,y:Ld,w:4.2,h:e*.16,d:4.2,rot:t}),b.push({x:a,z:o,y:Ld+e*.16,w:2.9,h:e*.6,d:2.9,rot:t}),b.push({x:a,z:o,y:Ld+e*.76,w:2,h:e*.24,d:2,rot:t}),x.push({x:a,z:o,y:Ld+e,h:3.6})}}});let C=Hd();this.buildingMat=new Eo({color:16777215,roughness:.85,emissive:16777215,emissiveMap:C,emissiveIntensity:0});let w=new Ai(new Pd(1,1,1,2,.06),this.buildingMat,b.length),T=new $t,E=new jt,D=new q(0,1,0),O=new q,k=new q,A=new X,j=[14276044,14276044,13618113,12894132,12172998,11114122,9667951,9345958];if(b.forEach((e,t)=>{E.setFromAxisAngle(D,e.rot),T.compose(O.set(e.x,e.y+e.h/2,e.z),E,k.set(e.w,e.h,e.d)),w.setMatrixAt(t,T),A.set(j[t%j.length]),A.multiplyScalar(.9+t*7%5*.035),w.setColorAt(t,A)}),w.castShadow=!0,w.receiveShadow=!0,this.scene.add(w),x.length>0){let e=new Ai(new Ki(.07,.1,1,5),new Eo({color:9145227,roughness:.7}),x.length);x.forEach((t,n)=>{T.makeScale(1,t.h,1),T.setPosition(t.x,t.y+t.h/2,t.z),e.setMatrixAt(n,T)}),this.scene.add(e)}let M=[];i.parks.forEach((e,t)=>{let n=Bd(2654435769+t),r=Math.max(4,Math.round(e.w*e.h/20)),i=-e.rot*Math.PI/180;for(let t=0;t<r;t++){let t=(n()-.5)*(e.w-2.5),r=(n()-.5)*(e.h-2.5);M.push({x:e.cx+t*Math.cos(i)+r*Math.sin(i),z:e.cy-t*Math.sin(i)+r*Math.cos(i),s:1+n()*.8})}}),i.stations.forEach((e,t)=>{let r=Bd(2246822507^t*2654435761);for(let t=0;t<5;t++){let t=r()*Math.PI*2,a=3.5+r()*12,o=e.x+Math.cos(t)*a,s=e.y+Math.sin(t)*a;n(i,o,s)&&(y(o,s)||l.some(e=>g(o,s,e)<2.4)||S.some(e=>Math.hypot(e.x-o,e.z-s)<e.r+.7)||M.push({x:o,z:s,s:.7+r()*.5}))}});let N=new Ai(new Ki(.13,.18,1,5),new Eo({color:7164470,roughness:1}),M.length),ee=new Ai(new fo(.85,1),new Eo({color:16777215,roughness:.95}),M.length);M.forEach((e,t)=>{let n=1.1*e.s;T.makeScale(e.s,n,e.s),T.setPosition(e.x,Ld+n/2,e.z),N.setMatrixAt(t,T),T.makeScale(e.s*1.5,e.s*1.35,e.s*1.5),T.setPosition(e.x,Ld+n+e.s*.9,e.z),ee.setMatrixAt(t,T),ee.setColorAt(t,A.setRGB(.15+t%3*.03,.4+t%5*.045,.17))}),N.castShadow=!0,ee.castShadow=!0,ee.receiveShadow=!0,this.scene.add(N,ee);{let e=_.x,t=_.z,n=new Z(new ho(10.5,3,10,44),new Eo({color:15262938,roughness:.8}));n.rotation.x=-Math.PI/2,n.scale.set(1.25,1,.95),n.position.set(e,3.1,t),n.castShadow=!0,n.receiveShadow=!0,this.scene.add(n);let r=new Z(new Gi(9.2,36),new Eo({color:7317607,roughness:1}));r.rotation.x=-Math.PI/2,r.scale.x=1.25,r.position.set(e,1.9200000000000002,t),this.scene.add(r),this.floodMat=new Eo({color:16774093,emissive:16772528,emissiveIntensity:0});let i=new Eo({color:9145227,roughness:.7});for(let[n,r]of[[-13.5,-10],[13.5,-10],[-13.5,10],[13.5,10]]){let a=new Z(new Ki(.16,.24,7.5,6),i);a.position.set(e+n,5.35,t+r),this.scene.add(a);let o=new Z(new Wi(1.7,.9,.4),this.floodMat);o.position.set(e+n,9.3,t+r),o.lookAt(e,Ld,t),this.scene.add(o)}}{let e=v.x,t=v.z,n=new Z(new Wi(7,.25,64),new Eo({color:4013376,roughness:.95}));n.position.set(e,1.9000000000000001,t),n.receiveShadow=!0,this.scene.add(n);let r=[];for(let n=-28;n<=28;n+=5.6){let i=new Wi(.45,.06,2.6);i.translate(e,2.0500000000000003,t+n),r.push(i)}this.scene.add(new Z(Fd(r),new Eo({color:16053488,roughness:.8})));let i=new Z(new Wi(11,.22,16),new Eo({color:9934747,roughness:.95}));i.position.set(e-9.5,1.87,t+12),i.receiveShadow=!0,this.scene.add(i);let a=new Z(new Pd(4.5,2.6,13,2,.5),new Eo({color:14538958,roughness:.7}));a.position.set(e-15.5,2.9000000000000004,t+12),a.castShadow=!0,this.scene.add(a);let o=new Z(new Ki(.6,.85,6.5,8),new Eo({color:13618113,roughness:.7}));o.position.set(e-15.5,4.800000000000001,t+2),o.castShadow=!0,this.scene.add(o);let s=new Z(new Ki(1.4,1.4,1.1,8),new Eo({color:2765632,roughness:.2,metalness:.4}));s.position.set(e-15.5,8.6,t+2),this.scene.add(s),this.beaconMat=new Eo({color:16733508,emissive:16724770,emissiveIntensity:0});let c=new Z(new mo(.35,8,8),this.beaconMat);c.position.set(e-15.5,9.5,t+2),this.scene.add(c);let l=new Eo({color:15922165,roughness:.4});for(let[n,r,i]of[[-8.5,8.5,.4],[-8.5,16,-.25]]){let a=new On,o=new Z(new Pd(1.1,.9,5.4,2,.4),l);o.position.y=.7,a.add(o);let s=new Z(new Wi(5.6,.12,1.1),l);s.position.y=.75,a.add(s);let c=new Z(new Wi(.12,1.1,.9),l);c.position.set(0,1.2,2.4),a.add(c),a.position.set(e+n,1.9000000000000001,t+r),a.rotation.y=i,this.scene.add(a)}}this.beamTex=Vd(`rgba(255,243,196,0.9)`,`rgba(255,243,196,0)`),r.bloom&&(this.composer=new Ed(this.renderer),this.composer.addPass(new Dd(this.scene,this.camera)),this.bloom=new kd(new K(1,1),.35,.5,.85),this.composer.addPass(this.bloom),this.composer.addPass(new jd)),this.resize()}beamTex;floodMat;beaconMat;addTrainVisual(e){{let t=this.game.city.lines.find(t=>t.id===e),n=this.beamTex,r=new On,i=new Eo({color:new X(t.color),emissive:new X(t.color),emissiveIntensity:0,roughness:.35,metalness:.2}),a=new Z(new Pd(4.4,1.5,1.7,3,.45),i);a.position.y=1.1,a.castShadow=!0,r.add(a);let o=new Z(new Pd(4,.55,1.74,2,.2),new Eo({color:1316895,roughness:.25,metalness:.4}));o.position.y=1.3,r.add(o);let s=new Z(new Pd(3.4,.35,1.3,2,.14),new Eo({color:15921906,roughness:.5}));s.position.y=1.95,r.add(s);let c=new si({map:n,blending:2,transparent:!0,depthWrite:!1,opacity:0}),l=new Z(new po(14,5),c);l.rotation.x=-Math.PI/2,l.position.set(9.2,.35,0),r.add(l),this.trainMats.push(i),this.beamMats.push(c),this.trainGroups.push(r),this.scene.add(r)}}pickStation(e,t){let n=new K(e/window.innerWidth*2-1,-(t/window.innerHeight)*2+1),r=new Es;r.setFromCamera(n,this.camera);let i=r.ray.origin,a=r.ray.direction;if(Math.abs(a.y)<1e-6)return null;let o=(Rd-i.y)/a.y;if(o<=0)return null;let s=i.x+a.x*o,c=i.z+a.z*o,l=Math.max(4,this.camera.position.distanceTo(this.controls.target)*.02),u=null,d=l;for(let e of this.game.city.stations){let t=Math.hypot(e.x-s,e.y-c);t<d&&(d=t,u=e.id)}return u}focusFrom=null;focusTo=null;focusT0=0;focusLine(e){let t=this.game.paths.get(e),n=1/0,r=-1/0,i=1/0,a=-1/0;for(let e of t.points)n=Math.min(n,e.x),r=Math.max(r,e.x),i=Math.min(i,e.y),a=Math.max(a,e.y);let o=new q((n+r)/2,0,(i+a)/2),s=Math.max(r-n,a-i,50),c=this.camera.position.clone().sub(this.controls.target).normalize(),l=o.clone().add(c.multiplyScalar(s*1.55+70));this.focusFrom={target:this.controls.target.clone(),pos:this.camera.position.clone()},this.focusTo={target:o,pos:l},this.focusT0=performance.now()}resize(){let e=window.innerWidth,t=window.innerHeight;this.camera.aspect=e/t,this.camera.updateProjectionMatrix(),this.renderer.setSize(e,t,!1),this.composer?.setSize(e,t)}render(){let e=this.game,t=e.nightFactor,n=new X(13624051),r=new X(15775102),i=new X(659744),a=t<.5?n.clone().lerp(r,t*2):r.clone().lerp(i,(t-.5)*2);this.scene.background=a,this.fog.color.copy(a),this.water.color.set(12440552).lerp(new X(1055532),t),this.landMat.color.set(15724006).lerp(new X(2896454),t*.85);let o=Math.PI*.27*(1-t)+.06;for(this.sun.position.set(this.controls.target.x+Math.cos(o)*500,Math.sin(o)*520+30,this.controls.target.z+180),this.sun.intensity=1.55*(1-t),this.sun.color.set(16773853).lerp(new X(16751442),Math.min(t*2,1)),this.hemi.intensity=.55*(1-t)+.2,this.nightAmbient.intensity=1.25*t;this.trainGroups.length<e.trains.length;)this.addTrainVisual(e.trains[this.trainGroups.length].lineId);if(this.focusTo&&this.focusFrom){let e=Math.min((performance.now()-this.focusT0)/1300,1),t=e<.5?2*e*e:1-(-2*e+2)**2/2;this.controls.target.lerpVectors(this.focusFrom.target,this.focusTo.target,t),this.camera.position.lerpVectors(this.focusFrom.pos,this.focusTo.pos,t),e>=1&&(this.focusTo=null,this.focusFrom=null)}this.trackMats.forEach((n,r)=>{let i=e.isUnlocked(e.city.lines[r].id);n.opacity=i?1:.3,n.emissiveIntensity=i?.18+.75*t:0}),this.buildingMat.emissiveIntensity=.55*t,this.lampMat.opacity=.55*t,this.floodMat.emissiveIntensity=1.5*t,this.beaconMat.emissiveIntensity=t*(.7+.7*Math.sin(performance.now()/280));for(let e of this.trainMats)e.emissiveIntensity=.7*t;for(let e of this.beamMats)e.opacity=.75*t;this.bloom&&(this.bloom.strength=.08+.55*t),e.trains.forEach((t,n)=>{let r=this.trainGroups[n];if(!r)return;let i=e.paths.get(t.lineId),a=i.segmentAt(t.distance),o=i.points[a],s=i.points[a+1],c=s.x-o.x,l=s.y-o.y,u=Math.hypot(c,l),d=u<.001?0:this.lanes.laneOf(t.lineId,a),f=u<.001?0:-l/u*d,p=u<.001?0:c/u*d,m=i.posAt(t.distance);r.position.set(m.x+f,2.3000000000000003,m.y+p);let h=Math.atan2(l*t.direction,c*t.direction);r.rotation.y=-h}),this.controls.update(),this.composer?this.composer.render():this.renderer.render(this.scene,this.camera)}};function Gd(e){return e>=1e9?(e/1e9).toFixed(2)+`B`:e>=1e6?(e/1e6).toFixed(2)+`M`:e>=1e4?(e/1e3).toFixed(1)+`K`:Math.floor(e).toLocaleString(`en-US`)}var Kd=class{game;cashEl=document.getElementById(`cash`);rateEl=document.getElementById(`rate`);phaseEl=document.getElementById(`phase`);panelEl=document.getElementById(`panel`);stationEl=document.getElementById(`station-card`);toastsEl=document.getElementById(`toasts`);mode=null;shownStationId=null;lastRefresh=0;structSeq=0;builtKey=``;constructor(e){this.game=e,document.getElementById(`btn-lines`).addEventListener(`click`,()=>{this.setMode(this.mode?.kind===`lines`||this.mode?.kind===`line`?null:{kind:`lines`})}),document.getElementById(`btn-network`).addEventListener(`click`,()=>{this.setMode(this.mode?.kind===`network`?null:{kind:`network`})}),this.panelEl.addEventListener(`click`,e=>this.onPanelClick(e)),this.stationEl.addEventListener(`click`,e=>this.onStationClick(e))}onUnlock=null;setMode(e){this.mode=e,this.panelEl.hidden=e===null,e&&this.hideStation(),this.structSeq++,e&&this.renderPanel()}onPanelClick(e){let t=this.game,n=e.target.closest(`[data-act]`);if(!n)return;let r=n.getAttribute(`data-act`),i=n.getAttribute(`data-id`)??``,a=this.mode?.kind===`line`?this.mode.id:i;switch(r){case`open-line`:this.setMode({kind:`line`,id:i});return;case`back`:this.setMode({kind:`lines`});return;case`buy-line`:t.buyLine(i)&&this.onUnlock?.(i);break;case`buy-train`:t.buyTrain(a);break;case`buy-speed`:t.buySpeed(a);break;case`buy-cars`:t.buyCars(a);break;case`buy-access`:t.buyAccess(a);break;case`buy-trainset`:t.buyTrainset(a);break;case`buy-tier`:t.buyStationTier(a,i);break;case`raise-priority`:t.raisePriority(i);break;case`buy-global`:t.buyGlobal(i)}this.structSeq++,this.renderPanel()}onStationClick(e){let t=e.target.closest(`[data-act]`);if(t){if(t.getAttribute(`data-act`)===`close-station`){this.hideStation();return}t.getAttribute(`data-act`)===`buy-work`&&(this.game.buyStationWork(t.getAttribute(`data-id`),this.shownStationId),this.cardKey=``,this.renderStation())}}showStation(e){this.shownStationId=e,this.setMode(null),this.stationEl.hidden=!1,this.cardKey=``,this.renderStation()}hideStation(){this.shownStationId=null,this.stationEl.hidden=!0}cardKey=``;renderStation(){let e=this.shownStationId;if(!e)return;let t=this.game,n=t.city.stations.find(t=>t.id===e),a=t.isServed(e),o=`${e}:${a}`;if(this.cardKey!==o){this.cardKey=o;let s=t.city.lines.filter(n=>t.isUnlocked(n.id)&&n.stationIds.includes(e)).map(e=>`<span class="bullet" style="background:${e.color}">${e.bullet}</span>`).join(``),c=a?i.map(n=>{let i=t.stationWorkLevel(n.id,e),a=i>=r.foodMax,o=a?0:t.stationWorkCost(n.id,i);return`<div class="row"><span class="nm">${n.name}</span>
              <span class="meta">L${i} · ${n.blurb}</span>
              <button data-act="buy-work" data-id="${n.id}" data-cost="${o}"
                ${a?`disabled`:``}>${a?`MAX`:`$`+Gd(o)}</button>
      ...
      <span class="head-bal">$<span class="bal">${Gd(this.game.cash)}</span></span></div>`}renderPanel(){if(this.game,!this.mode)return;let e=`${JSON.stringify(this.mode)}:${this.structSeq}`;if(e===this.builtKey){this.refreshLive();return}this.builtKey=e,this.mode.kind===`lines`?this.panelEl.innerHTML=this.linesHtml():this.mode.kind===`line`?this.panelEl.innerHTML=this.lineHtml(this.mode.id):this.panelEl.innerHTML=this.networkHtml(),this.refreshLive()}linesHtml(){let e=this.game,t=e.city.lines.map(t=>{let n=`<span class="bullet" style="background:${t.color}">${t.bullet}</span>`;if(!e.isUnlocked(t.id)){let e=t.unlockCost;return`<div class="row locked">${n}<span class="nm">${t.name}</span>
            <span class="meta">${t.stationIds.length} stops</span>
            <button data-act="buy-line" data-id="${t.id}" data-cost="${e}">
              OPEN · $${Gd(e)}</button></div>`}let r=e.trainCount(t.id),i=e.speedLevelOf(t.id)+e.carLevelOf(t.id)+e.accessLevelOf(t.id)+e.trainsetLevelOf(t.id);return`<div class="row" data-act="open-line" data-id="${t.id}">
        ...
        <button data-act="${e}" data-cost="${o?0:a}" ${o?`disabled`:``}>
          ${o?`MAX`:`$`+Gd(a)}</button></div>`},s=t.nextTrainCost(e),c=t.nextPlannedType(e),l=i.slice().sort((e,n)=>t.stationPriority.indexOf(e.id)-t.stationPriority.indexOf(n.id)).map(n=>{let i=t.minStationLevel(e,n.id),a=i>=r.foodMax,o=a?0:t.stationsAtMin(e,n.id),s=t.stationTierCost(e,n.id);return`<div class="row${n.id===c?` next`:``}">
