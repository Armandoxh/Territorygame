...
|---|---|---|---|---|
| **Metro Magnate** | `metro/` | armandoxh.github.io/Territorygame/metro/ | v0.16.0 · build 36 | **Active** — NEW MERIDIAN XL live with the four-tab console; OPS runs five rotating contract types; 22-rung mastery goal ladder |
