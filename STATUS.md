...
|---|---|---|---|---|
| **Metro Magnate v2** | `metro2/` | armandoxh.github.io/Territorygame/metro2/ | v2 · b38 | **Active** — WebGL render proof: the approved XL map as a 3D city (three.js), ported deterministic sim core, night-rush light cycle |
