...
|---|---|---|---|---|
| **Metro Magnate** | `metro/` | armandoxh.github.io/Territorygame/metro/ | v0.13.0 · build 32 | **Active** — approved 9-line network LIVE with per-line upgrades + NETWORK tab (signals, doors, marketing, fare reviews), rebalanced demand |
