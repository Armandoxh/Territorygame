...
|---|---|---|---|---|
| **Metro Magnate** | `metro/` | armandoxh.github.io/Territorygame/metro/ | v0.14.0 · build 33 | **Active** — approved 9-line network LIVE with per-line upgrades + NETWORK tab (signals, doors, marketing, fare reviews), rebalanced demand |
